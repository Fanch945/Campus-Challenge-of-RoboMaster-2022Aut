							  ...
							  motor_stop();
								...
								switch(case_identifier){
									...
									case(1):  //No.1
										...
										PWM_SetDutyRatio(&pwm1[2],0.025);  //right MG up about 30drg  /////*****/////
									...
									case(2):  //No.2
										...
										PWM_SetDutyRatio(&pwm1[2],0.060);  //right MG up about 30drg  /////*****/////
										auto_horizonally_catch(1500,1500,2000);  /////*****/////
										break;
									...
									case(5):  //No.Ground
										...
										PWM_SetDutyRatio(&pwm1[1],0.025);  //left MG ortha to ground
										delay(500);
										break;
									case(6):  //bank
										PWM_SetDutyRatio(&pwm1[4],0.100);  //top SG pi+B  /////*****/////
